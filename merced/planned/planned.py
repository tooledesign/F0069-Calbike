...
i.import_osm_network(osm_file="/home/sgardner/Merced PG 8 11 20.osm",keep_holding_tables=True)
...
bna.travel_sheds(["060470013023031","060470013023032"],"automated.merced_planned_hsr_travel_shed",overwrite=True)
