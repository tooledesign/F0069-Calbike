...
UPDATE generated.fresno_proposed_streets s
SET
    fwd_seg_stress = 1,
    bwd_seg_stress = 1,
    fwd_int_stress = 1,
...
WHERE EXISTS (
    SELECT 1
    FROM generated.fresno_proposed_osm_ways w
    WHERE
        w.osmid && s.osmid
...
CREATE TEMP TABLE tmp_trails AS (
    ...
    FROM generated.fresno_proposed_streets
...
UPDATE generated.fresno_proposed_streets
SET
    fwd_seg_stress = 1,
    bwd_seg_stress = 1,
    fwd_int_stress = 1,
...
-- process projects
ALTER TABLE generated.fresno_proposed_streets ADD COLUMN IF NOT EXISTS project TEXT;
...
CREATE TEMP TABLE tmp_prjs AS (
    SELECT
        ...
        w.project
    FROM
        generated.fresno_proposed_streets s,
        generated.fresno_proposed_osm_ways w
    WHERE
        w.osmid && s.osmid
